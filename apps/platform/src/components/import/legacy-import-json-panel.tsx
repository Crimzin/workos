...
export function LegacyImportJsonPanel() {
  ...
  return (
    <details className="border-t border-border bg-bg-secondary">
      <summary className="cursor-pointer px-6 py-3 text-sm font-medium text-text-secondary hover:bg-bg-hover">
        Legacy preview JSON import
      </summary>
      <div className="grid gap-4 border-t border-border p-5 md:grid-cols-[minmax(320px,420px)_1fr]">
        <section>
          <label
            className="block text-sm font-medium"
            htmlFor="import-preview-json"
          >
            Preview JSON
          </label>
          <textarea
            ...
            className="mt-2 h-72 w-full resize-none rounded-md border border-border bg-bg-card p-3 font-mono text-xs text-text-primary outline-none placeholder:text-text-tertiary focus:ring-2 focus:ring-accent"
